...
// 10% - Voucher giảm 2,200,000Đ khi mua gói VIP 4,500,000Đ
// 20% - Voucher giảm 2,000,000Đ khi mua gói VIP 4,500,000Đ
// 15% - Tặng gói Gold 2,500,000Đ khi mua gói VIP giá gốc 4,500,000Đ giảm còn 2,500,000Đ
// 20% - Voucher 500.000Đ áp dụng khi nâng cấp lên gói VIP
// 15% - Voucher 800.000Đ áp dụng khi nâng cấp lên gói VIP
...
const goldPrizes = [
  ...
  {
    text: 'Tặng gói Gold 2,500,000Đ khi mua gói\nVIP giá gốc 4,500,000Đ giảm còn 2,500,000Đ',
    textFontSize: 14,
    textFontFamily: 'Arial',
    fillStyle: '#fc0',
    textFillStyle: '#fff',
    description:
      'Tặng gói Gold Iconic giá trị 2.500.000đ khi mua gói VIP giá gốc 4.500.000đ giảm còn 2.500.000đ',
    chance: 15,
  },
  {
    text: 'Voucher 500.000Đ áp dụng\nkhi nâng cấp lên gói VIP',
    textFontSize: 14,
    textFontFamily: 'Arial',
    fillStyle: '#ff0000',
    textFillStyle: '#fff',
    description: 'Voucher 500.000Đ áp dụng khi nâng cấp lên gói VIP',
    chance: 20,
  },
  {
    text: 'Voucher 800.000Đ áp dụng\nkhi nâng cấp lên gói VIP',
    textFontSize: 14,
    textFontFamily: 'Arial',
    fillStyle: '#fc0',
    textFillStyle: '#fff',
    description: 'Voucher 800.000Đ áp dụng khi nâng cấp lên gói VIP',
    chance: 15,
  },
  {
...
function initLuckyWheel() {
  ...
  const prizeList = document.querySelector('#gold-prize-list ul');

  if (prizeList) {
    // prizeList.style.display = 'block'; // Hiển thị danh sách phần thưởng GOLD

    goldPrizes.forEach((prize) => {
      const listItem = document.createElement('li');
      listItem.innerHTML = `<i
                      class="fas fa-fingerprint"
                      style="margin-right: 8px; color: var(--color-3)"
                    ></i
                    >${prize.description}`;
...
function handleDragEnd(e) {
  ...
  var totalSpinsUsed = spinCount.gold;
